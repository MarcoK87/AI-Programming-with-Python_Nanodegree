...
def calculates_results_stats(results_dic):
    ...
    pct_match = 0 if n_images == 0 else (n_match / n_images) * 100
    pct_correct_dogs = 0 if n_dogs_img == 0 else (n_correct_dogs / n_dogs_img) * 100
    pct_correct_breed = 0 if n_correct_dogs == 0 else (n_correct_breed / n_correct_dogs) * 100
    pct_correct_notdogs = 0 if n_notdogs_img == 0 else  (n_correct_notdogs / n_notdogs_img) * 100
